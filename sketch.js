...
function preload() {
    myGif = loadImage('/workshop/bookofart.gif');  // Replace with your GIF path
}
// ==============================================
...
function draw() 
{
    ...
    strokeWeight(2);
     image(myGif, width/4, height/4, width/2, height/2);
